...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F7EDE2] to-[#F3D9DC] text-gray-800 font-light">
      ...
      <h2 className="flex justify-center gap-6 py-6">MAJ: Spotify a changé sa politique d'API donc beaucoup de features sont dépréciées et ne fonctionnent plus.</h2>
        ...
        {selectedTrackId && audioFeatures && (
          <div className="mt-6 p-4 bg-gray-100 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-2">
              Audio Features de "{getActiveData().find(track => track.id === selectedTrackId)?.name}"
            </h3>
            <ul>
              <li><strong>Acousticness:</strong> {audioFeatures.acousticness}</li>
              <li><strong>Danceability:</strong> {audioFeatures.danceability}</li>
              <li><strong>Instrumentalness:</strong> {audioFeatures.instrumentalness}</li>
              <li><strong>Loudness:</strong> {audioFeatures.loudness}</li>
              <li><strong>Speechiness:</strong> {audioFeatures.speechiness}</li>
              <li><strong>Tempo:</strong> {audioFeatures.tempo} BPM</li>
            </ul>
          </div>
        )}
      </div>
